...
parser.add_argument('--fm', type=str, help='feature matrix',
        default='../../data/features/cand_parse_all_2014_feat_matrix_trim_normed.pkl')
...
def main():
    ...
    data_2 = pd.read_pickle('../../data/features/cand_parse_all_2012_feat_matrix_trim_normed.pkl')
    data_3 = pd.read_pickle('../../data/features/cand_parse_all_2010_feat_matrix_trim_normed.pkl') 
    ...
    for id1 in data_IDs:
        for i, id2 in enumerate( cands['CID'] ):
            if id1 == id2:
                dw0.append(cands['DWN-0'][i])
                dw1.append(cands['DWN-1'][i])
    ...
    X_train, X_test, Y_train, Y_test = cross_validation.train_test_split(X_raw, DWN_0, test_size=0.4, random_state=0)
    X_train_2, X_test_2, Y_train_2, Y_test_2 = cross_validation.train_test_split(X_raw, DWN_1, test_size=0.4, random_state=0)
